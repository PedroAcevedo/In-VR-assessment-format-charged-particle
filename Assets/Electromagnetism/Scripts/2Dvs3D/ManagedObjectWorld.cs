...
// Class for unmanaged types for the Unity Jobs system. Taken from: https://www.jacksondunstan.com/articles/5397
public class ManagedObjectLines
{
    private int m_NextId;
    private readonly Dictionary<int, object> m_Objects;

    public ManagedObjectLines(int initialCapacity = 1000)
    {
        m_NextId = 1;
